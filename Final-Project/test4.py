...
# page_to_scrape = requests.get("https://www.worldfootball.net/goalgetter/eng-premier-league-2017-2018/")
# soup = BeautifulSoup(page_to_scrape.text, "html.parser")
# goals = soup.findAll("td", attrs={"class":""})
# scorers = soup.findAll("a",attrs={"align":"center"})
